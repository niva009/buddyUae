...
import { GET_REVIEW, PRODUCT_VIEW, newRequest } from "../api";
...
export default function Product() {
  ...
  return (
    <>
      <Helmet>
        <title>Buddy Star | {productDetails?.product?.name ?? ""}</title>
        <meta
          name="description"
          content={productDetails?.product?.meta_description ?? ""}
        />
        <meta
          name="keywords"
          content={productDetails?.product?.meta_keywords}
        />
        <meta
          property="og:title"
          content={productDetails?.product?.meta_title ?? ""}
        />
        <meta
        ...
        <meta
          property="og:image"
          content={productDetails?.product?.meta_img ?? ""}
        />
        ...
        <>
          <div className="flex flex-col lg:flex-row px-4 md:pl-4 pl-8 md:px-4 lg:pl-0 sm:px-20 xl:px-48 gap-10 pt-10 pb-5">
            ...
            <div className="flex w-full flex-col gap-1">
              ...
              <Link
                to={`/store/?brand=${productDetails?.product?.brand_id}`}
            ...
            <>
              {selectedTab == 0 && (
                <div role="tabpanel" className="w-full py-5 pl-7 md:pl-0">
                  ...
                  <Link
                    target="_blank"
                    to={productDetails?.product?.pdf_link}
          ...
          <div className="items-center w-full justify-between pb-14 flex-col gap-2">
            <div className="grid lg:px-48 grid-cols-2">
              ...
              <div className="flex flex-col text-[0.94rem] text-end justify-end font-semibold underline underline-offset-4">
                <Link to="/shop" className="flex justify-end gap-2" href="">
