...
const categories = [
  ...
  { name: "Flip charts and White Boards", description: "Capture ideas and inspire creativity with our versatile flip charts, designed to enhance brainstorming sessions and presentations with ease and clarity.", image: "/home/card/card-10.jpg", categoryId: 10 },
...
export default function CategoryCard() {
  const handleCategoryClick = (categoryId, name) => {
    // Save categoryId in localStorage
